						...
						<div className="col-lg-3 col-md-6 col-12">
							<div className="d-flex flex-column">
								...
								<ul style={{listStyle:'none'}}>
									...
									<li><i class="fa-solid fa-circle-chevron-right mr-10"></i><Link href="https://www.facebook.com/rjakash88/videos/560419008857402/?extid=CL-UNK-UNK-UNK-AN_GK0T-GK1C" target='_blank'>MU By Rj Akash</Link></li>
								</ul>
								<h6>Grow With Us</h6>
								<ul style={{listStyle:'none'}}>
