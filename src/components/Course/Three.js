	...
	return (
		<div className={courseClass ? courseClass : 'it-class-item text-center'}>
			<div className="it-class-thumb p-relative">
				<div className="fix">
					<Image src={Img ? Img : '/img/class/class-1-1.jpg'} alt={Title ? Title : ""} width={imgWidth ? imgWidth : 422} height={imgHeight ? imgHeight : 221} />
				</div>
			...
			<div className="it-class-text">
				<h4 className="it-class-title">
					<Link href={`/course/${Slug ? Slug : 'details'}`}>{Title ? Title : 'Painting class For Young Children'}</Link>
				</h4>
