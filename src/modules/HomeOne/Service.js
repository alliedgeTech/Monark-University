    ...
    <>
      <div className="mu_course pt-4">
        <div className="container">
          <div className="highlight_section container mt-5 py-5">
            <div
              id="carouselExampleIndicators"
              className="carousel carousel1 slide mt-5"
            >
              <div className="row flex-row-reverse">
                ...
                <div
                  className="col-lg-6 d-flex align-items-center mt-lg-0 mt-4"
                  data-aos="zoom-in-right"
                >
                  <div className="carousel-buttons carousel-orange-buttons mr-auto mb-30 d-flex align-items-center">
                    <button
                      type="button"
              ...
              <div className="carousel-inner mt-30">
                        ...
                        {homecourse.map((item, index) => (
                          ...
                          >
                            <Link href={`/services/service?id=${index + 1}`}>
                              <div
                                className="course-link-box px-2 py-3 d-flex align-items-center"
                                data-aos="fade-up"
                              >
